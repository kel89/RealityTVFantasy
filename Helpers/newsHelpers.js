    ...
    let newsData = [
    	{
    		date: "Week 6",
    		news: `
    		<p class="x_MsoNormal" style="margin: 0in 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><strong><span style="font-size: 14pt; font-family: &quot;Calibri Light&quot;, sans-serif;">The Bachelor</span></strong></p>
<p class="x_MsoNormal" style="margin: 0in 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><strong><span style="font-family: &quot;Calibri Light&quot;, sans-serif; color: red;">Spoilers if you haven’t watched last night’s March 2<sup>nd</sup><span class="Apple-converted-space">&nbsp;</span>episode!</span></strong></p>
<p class="x_MsoNormal" style="margin: 0in 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><span style="font-family: &quot;Calibri Light&quot;, sans-serif;">I truly cannot recap this episode in a work email but we have<span class="Apple-converted-space">&nbsp;</span><strong>Hannah Ann</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Martyna</em>),<span class="Apple-converted-space">&nbsp;</span><strong>Victoria F</strong>(<em>Andrew</em>), and<span class="Apple-converted-space">&nbsp;</span><strong>Madison</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Nate</em>) remaining. Hannah Ann’s date with Peter goes well, as does Victoria F’s. Madison’s date with Peter hits a big snag, and she departs in tears—her future with Peter uncertain. Going into the rose ceremony, Peter is extremely conflicted and is unsure if Madison will even show up for the ceremony. At the last minute Madi arrives. Peter gives the first rose to Hannah Ann, who accepts. After a very long and dramatic pause, he asks Madison if she will accept his rose. She hesitates, but eventually says yes. She waits so long to respond that Peter asks, “You sure?” Yikes. Victoria F is sent home.</span></p>
<p class="x_MsoNormal" style="margin: 0in 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><strong><span style="font-family: &quot;Calibri Light&quot;, sans-serif;">&nbsp;</span></strong></p>
<p class="x_MsoNormal" style="margin: 0in 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><strong><span style="font-size: 14pt; font-family: &quot;Calibri Light&quot;, sans-serif;">Project Runway</span></strong></p>
<p class="x_MsoNormal" style="margin: 0in 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><span style="font-family: &quot;Calibri Light&quot;, sans-serif;">Since no one was sent home last week, this week’s challenge was high stakes with 2 designers sent home. The challenge was Avant-Garde—French for “advanced guard”, it means art and designs that are experimental, radical, and unorthodox. In other words, they’re making outfits that no person could ever wear outside a runway. The runway show took place at The Vessel, an architecturally unique structure in NYC. Everyone did an astounding job, but unfortunately only 4 can advance to the Finale. In the end,<span class="Apple-converted-space">&nbsp;</span><strong>Brittany</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Marie</em>) and<span class="Apple-converted-space">&nbsp;</span><strong>Marquise</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Brock</em>) designed looks that fell short.<span class="Apple-converted-space">&nbsp;</span><strong>Geoffrey<span class="Apple-converted-space">&nbsp;</span></strong>(<em>Martyna</em>),<strong>Victoria<span class="Apple-converted-space">&nbsp;</span></strong>(<em>Maddie</em>),<span class="Apple-converted-space">&nbsp;</span><strong>Nancy</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Shelley</em>), and<span class="Apple-converted-space">&nbsp;</span><strong>Sergio</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Marie</em>) advance to the finale where they’ll have months to create a full collection to show at New York Fashion Week.</span></p>
<p class="x_MsoNormal" style="margin: 0in 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><strong><span style="font-family: &quot;Calibri Light&quot;, sans-serif;">&nbsp;</span></strong></p>
<p class="x_MsoNormal" style="margin: 0in 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><strong><span style="font-size: 14pt; font-family: &quot;Calibri Light&quot;, sans-serif;">Kids Baking Championship</span></strong></p>
<p class="x_MsoNormal" style="margin: 0in 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><span style="font-family: &quot;Calibri Light&quot;, sans-serif;">The five remaining bakers competed this week to design the best trifle, a layered creation of cake, fruits, and mousses. Design played a big part in the bakers’ scores this week.<span class="Apple-converted-space">&nbsp;</span><strong>Reggie</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Alex G</em>) created a delicious, fruity trifle with beautiful, defined layers that wowed the judges and won him the challenge.<strong>Morgan</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Marie</em>) and<span class="Apple-converted-space">&nbsp;</span><strong>Sam</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Andrew</em>) also performed well.<span class="Apple-converted-space">&nbsp;</span><strong>Liam</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Shelley</em>) stumbled a lot this week. He forgot to add eggs to his batter and had to start over, then over-whipped his chocolate mousse.<strong>Graysen</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Jerry</em>) also struggled with her trifle, only filling it up halfway and leaving the judges wanting more. Graysen and Liam were the bottom two, but Liam was the unlucky baker sent home. Reggie, Morgan, Sam, and Graysen all advance to the semifinals.<span class="Apple-converted-space">&nbsp;</span></span></p>
<p class="x_MsoNormal" style="margin: 0in 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><strong><span style="font-size: 14pt; font-family: &quot;Calibri Light&quot;, sans-serif;">&nbsp;</span></strong></p>
<p class="x_MsoNormal" style="margin: 0in 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><strong><span style="font-size: 14pt; font-family: &quot;Calibri Light&quot;, sans-serif;">Survivor</span></strong></p>
<p class="x_MsoNormal" style="margin: 6pt 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><span style="font-family: &quot;Calibri Light&quot;, sans-serif;">The contestants for this season of Survivor continued their Winners at War battle as a fourth player was voted out and send to the Edge of Extinction! This week’s loss was<span class="Apple-converted-space">&nbsp;</span><strong>Ethan Zohn</strong>, who was one of Jessica’s picks, and his elimination was sad for a lot of fans who thought he’d last far longer.</span></p>
<p class="x_MsoNormal" style="margin: 6pt 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><span style="font-family: &quot;Calibri Light&quot;, sans-serif;">In the Dakal (Red tribe),<span class="Apple-converted-space">&nbsp;</span><strong>Sophia</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Undrafted</em>) is in a pretty good spot thanks to having half of a hidden immunity idol, thanks to (in her words)<span class="Apple-converted-space">&nbsp;</span><strong>Kim</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Undrafted</em>) trusting the wrong person.<span class="Apple-converted-space">&nbsp;</span><strong>Nick</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Martyna</em>) meanwhile has ended up working with some of the ‘old-school players’ since none of them had pre-existing relationships. It remains to be seen how this will work out for him.<span class="Apple-converted-space">&nbsp;</span><strong>Tyson</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Nate</em>) has turned things around since an iffy first week, but<span class="Apple-converted-space">&nbsp;</span><strong>Sandra</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Jessica</em>) knows he’s been throwing her name around.</span></p>
<p class="x_MsoNormal" style="margin: 6pt 0in 0.0001pt; font-size: 11pt; font-family: Calibri, sans-serif; caret-color: rgb(0, 0, 0); color: rgb(0, 0, 0); font-style: normal; font-variant-caps: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: auto; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; text-decoration: none;"><span style="font-family: &quot;Calibri Light&quot;, sans-serif;">In the Sele (Blue Tribe),<span class="Apple-converted-space">&nbsp;</span><strong>Ben</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Nate</em>) has proven he’s not quite in the top tier of winners. His skills in the game pale in comparison to many of the people he’s ended up against so far.<span class="Apple-converted-space">&nbsp;</span><strong>Rob</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Alex C</em>) and<span class="Apple-converted-space">&nbsp;</span><strong>Parvati</strong>(<em>Jerry</em>) still look like they’re in control of the game despite a week showing in the challenge last week. Finally,<span class="Apple-converted-space">&nbsp;</span><strong>Adam</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Jessica</em>) seems like he’s on the outs, especially since he gave half of his immunity idol to<strong>Denise</strong><span class="Apple-converted-space">&nbsp;</span>(<em>Undrafted</em>), meaning she now has a full idol! Her position looks far better.</span></p>
    		`
    	},
		{
			date: "Week 5",
